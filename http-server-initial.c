...
int main(int argc, char *argv[])
{
    ...
    for (;;) {
        ...
        swrite(newsockfd,"\n");
        swrite(newsockfd,"<html><body><h2>Hello, World!</h2></body></html>\n");
...
- This version sends a hard-coded HTTP/1.0 response when the client
  connects.

*/

/*
# This: http-server-initial.c
# Prev: server-loop.c
# Next: http-server-fetch.c

# Build & run:
gcc http-server-initial.c -o http && ./http 9001
*/
